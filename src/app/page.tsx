...
export default function Home() {
  return (
    <div className="font-sans text-zinc-50 dark:bg-[#080b12] min-h-screen">
      ...
      <section id="inicio" className="relative flex flex-col items-center justify-center min-h-screen dark:bg-[url('/ElFInal.jpg')] dark:bg-cover dark:bg-bottom dark:bg-no-repeat">
      ...
      <section className="relative z-10 w-full min-h-screen bg-[#080b12] flex flex-col items-center py-20 px-6">
        <div className="max-w-5xl w-full flex flex-col gap-24">
          ...
          <div id="novedades" className="text-center scroll-mt-28">
